...
INSERT INTO `items` (`items_id`, `items_name`, `items_image`, `items_cost`, `items_delete`, `items_add_date`, `items_count`, `item_chef_id`, `item_category`, `item_meal_type`, `item_status`, `items_rateing`, `items_offer`) VALUES
(1, 'brike', '2022-03-02_1646238597.jpg', 20, 0, '2022-03-02 21:59:57', 0, 100003, 0, 1, 1, 0, 10),
(2, 'Green Lays', '2023-10-14_1697304972.jpg', 30, 0, '2022-03-02 22:08:54', 84, 100001, 0, 3, 1, 0, 20),
(3, 'Butter Biscuits', '2022-07-25_1658765093.jpeg', 50, 0, '25-07-2022 09:28:32 ', 49, 100001, 0, 2, 1, 0, 0),
(4, 'lays', '', 10, 0, '2023-10-05 05:46:06 ', 2, 100001, 0, 3, 1, 0, 0),
(100001, 'Dairy Milk', '2023-10-14_1697304773.jpg', 20, 0, '2023-10-14 11:02:53 ', 36, 100003, 0, 2, 0, 0, 0),
(100002, 'diry', '2023-11-23_1700729724.png', 20, 0, '2023-11-23 02:25:24 ', 2, 100000, 0, 3, 1, 0, 0),
(100003, 'Update_age', '2024-01-23_1706015459.png', 23, 0, '2024-01-23 06:40:59 ', 0, 100003, 1, 2, 0, 0, 0),
(100004, 'esmdxn es', '2024-01-23_1706018839.png', 120, 0, '2024-01-23 07:37:19 ', 0, 100003, 0, 3, 0, 0, 0),
(100005, 'available_not_exceed', '2024-01-29_1706514119.png', 300, 0, '2024-01-29 01:11:59 ', 0, 100003, 0, 3, 1, 0, 0),
(100006, 'biriyani', '2024-01-29_1706514773.jpg', 600, 0, '2024-01-29 01:22:53 ', 0, 100003, 1, 4, 1, 0, 20);
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100283;
...
--
ALTER TABLE `items`
  MODIFY `items_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100007;
...
--
ALTER TABLE `transaction`
  MODIFY `transaction_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100215;
COMMIT;
